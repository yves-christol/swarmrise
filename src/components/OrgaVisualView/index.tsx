...
export function OrgaVisualView({ orgaId, onRegisterNodePositionLookup }: OrgaVisualViewProps) {
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div>
                ...
                <p className="text-text-description max-w-sm">
  ...
  return (
    ...
    >
      ...
      {isSimulating && (
        <div className="absolute top-4 left-4 px-3 py-1 bg-surface-primary rounded-full text-xs text-text-description flex items-center gap-2 border border-border-strong">
