    ...
    <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
      <div className="flex items-start justify-between mb-3">
        ...
        {data.orga.logoUrl ? (
          ...
          <div className="w-10 h-10 rounded bg-gray-700 flex items-center justify-center ml-3 flex-shrink-0">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 px-3 py-1.5
            border border-gray-600 hover:border-gray-500 disabled:opacity-50
