        ...
        <div className="px-4 py-3 space-y-3 overflow-y-auto min-h-0 flex-1">
          ...
          <div>
            ...
            <select
              ...
              className="w-full text-sm bg-slate-100 dark:bg-slate-800 text-dark dark:text-light rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#eac840] focus:ring-offset-1 focus:ring-offset-light dark:focus:ring-offset-dark"
            >
